...
function Price({ dark = false }: { dark?: boolean }) { return <span className={dark ? 'price price-dark' : 'price'}>₹10<span>/-</span></span>; }
function App() {
